...
def predict_used_car_price(Age,Experience,Income,Family,CCAvg,Education,Mortgage,security_account,cd_account,Online,CreditCard):
...
def main():
    ...
    if st.button("Predict"):
        result=predict_used_car_price(Age,Experience,Income,Family,CCAvg,Education,Mortgage,security_account,cd_account,Online,CreditCard)
